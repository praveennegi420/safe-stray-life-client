...
export default function Profile() {
    ...
    useEffect(() => {
        axios.post('https://safe-stray-life-server.vercel.app/getprofile', {
    ...
    const removeImage = (id) =>{
        axios.post('https://safe-stray-life-server.vercel.app/deletepost',{ id, user: data.data._id })
    ...
    const beVolunteer= () => {
        ...
        axios.post('https://safe-stray-life-server.vercel.app/be-volunteer', {volunteer: !data.data.volunteer, token: localStorage.getItem('token') }, { headers: { 'content-type' : 'application/json'} })
